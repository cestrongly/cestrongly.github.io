...
`,[N("scrollbar",`
 ...
 `,[N("base-loading",`
 color: var(--n-loading-color);
 `),N("base-selection-tags","min-height: var(--n-height);"),Y("border, state-border",`
 position: absolute;
 left: 0;
 right: 0;
 top: 0;
 ...
 `),N("base-selection-label","background-color: var(--n-color-active);"),N("base-selection-tags","background-color: var(--n-color-active);")])]),oe("disabled","cursor: not-allowed;",[Y("arrow",`
 ...
 `),N("base-selection-label",`background-color: var(--n-color-active-${e});`),N("base-selection-tags",`background-color: var(--n-color-active-${e});`)]),oe("focus",[Y("state-border",`
 ...
 display: inline-flex;
 padding: 0 7px 3px 0;
 `,[re("&:last-child","padding-right: 0;"),N("tag",`
 font-size: 14px;
 max-width: 100%;
 `,[Y("content",`
 line-height: 1.25;
 ...
 `,[Mt({originalTransition:"background-color .3s var(--n-bezier), box-shadow .3s var(--n-bezier)"})])]),To=Object.assign(Object.assign({},Ce.props),{to:at.propTo,bordered:{type:Boolean,default:void 0},clearable:Boolean,clearFilterAfterSelect:{type:Boolean,default:!0},options:{type:Array,default:()=>[]},defaultValue:{type:[String,Number,Array],default:null},value:[String,Number,Array],placeholder:String,menuProps:Object,multiple:Boolean,size:String,filterable:Boolean,disabled:{type:Boolean,default:void 0},remote:Boolean,loading:Boolean,filter:Function,placement:{type:String,default:"bottom-start"},widthMode:{type:String,default:"trigger"},tag:Boolean,onCreate:Function,fallbackOption:{type:[Function,Boolean],default:void 0},show:{type:Boolean,default:void 0},showArrow:{type:Boolean,default:!0},maxTagCount:[Number,String],consistentMenuWidth:{type:Boolean,default:!0},virtualScroll:{type:Boolean,default:!0},labelField:{type:String,default:"label"},valueField:{type:String,default:"value"},childrenField:{type:String,default:"children"},renderLabel:Function,renderOption:Function,renderTag:Function,"onUpdate:value":[Function,Array],inputProps:Object,nodeProps:Function,ignoreComposition:{type:Boolean,default:!0},onUpdateValue:[Function,Array],onBlur:[Function,Array],onClear:[Function,Array],onFocus:[Function,Array],onScroll:[Function,Array],onSearch:[Function,Array],onUpdateShow:[Function,Array],"onUpdate:show":[Function,Array],displayDirective:{type:String,default:"show"},resetMenuOnOptionsChange:{type:Boolean,default:!0},status:String,showCheckmark:{type:Boolean,default:!0},onChange:[Function,Array],items:Array}),_o=se({name:"Select",props:To,setup(e){const{mergedClsPrefixRef:t,mergedBorderedRef:n,namespaceRef:o,inlineThemeDisabled:l}=pn(e),s=Ce("Select","-select",Co,mn,e,t),a=P(e.defaultValue),r=te(e,"value"),p=pt(r,a),c=P(!1),y=P(""),x=V(()=>{const{valueField:i,childrenField:h}=e,O=wo(i,h);return vo(w.value,O)}),M=V(()=>So($.value,e.valueField,e.childrenField)),_=P(!1),b=pt(te(e,"show"),_),F=P(null),W=P(null),T=P(null),{localeRef:k}=On("Select"),E=V(()=>{var i;return(i=e.placeholder)!==null&&i!==void 0?i:k.value.placeholder}),m=Fn(e,["items","options"]),S=[],R=P([]),D=P([]),H=P(new Map),Z=V(()=>{const{fallbackOption:i}=e;if(i===void 0){const{labelField:h,valueField:O}=e;return K=>({[h]:String(K),[O]:K})}return i===!1?!1:h=>Object.assign(i(h),{value:h})}),$=V(()=>D.value.concat(R.value).concat(m.value)),v=V(()=>{const{filter:i}=e;if(i)return i;const{labelField:h,valueField:O}=e;return(K,z)=>{if(!z)return!1;const A=z[h];if(typeof A=="string")return it(K,A);const I=z[O];return typeof I=="string"?it(K,I):typeof I=="number"?it(K,String(I)):!1}}),w=V(()=>{if(e.remote)return m.value;{const{value:i}=$,{value:h}=y;return!h.length||!e.filterable?i:xo(i,v.value,h,e.childrenField)}});function B(i){const h=e.remote,{value:O}=H,{value:K}=M,{value:z}=Z,A=[];return i.forEach(I=>{if(K.has(I))A.push(K.get(I));else if(h&&O.has(I))A.push(O.get(I));else if(z){const J=z(I);J&&A.push(J)}}),A}const U=V(()=>{if(e.multiple){const{value:i}=p;return Array.isArray(i)?B(i):[]}return null}),q=V(()=>{const{value:i}=p;return!e.multiple&&!Array.isArray(i)?i===null?null:B([i])[0]||null:null}),G=yn(e),{mergedSizeRef:L,mergedDisabledRef:X,mergedStatusRef:d}=G;function g(i,h){const{onChange:O,"onUpdate:value":K,onUpdateValue:z}=e,{nTriggerFormChange:A,nTriggerFormInput:I}=G;O&&le(O,i,h),z&&le(z,i,h),K&&le(K,i,h),a.value=i,A(),I()}function j(i){const{onBlur:h}=e,{nTriggerFormBlur:O}=G;h&&le(h,i),O()}function ee(){const{onClear:i}=e;i&&le(i)}function ae(i){const{onFocus:h}=e,{nTriggerFormFocus:O}=G;h&&le(h,i),O()}function Te(i){const{onSearch:h}=e;h&&le(h,i)}function ke(i){const{onScroll:h}=e;h&&le(h,i)}function be(){var i;const{remote:h,multiple:O}=e;if(h){const{value:K}=H;if(O){const{valueField:z}=e;(i=U.value)===null||i===void 0||i.forEach(A=>{K.set(A[z],A)})}else{const z=q.value;z&&K.set(z[e.valueField],z)}}}function pe(i){const{onUpdateShow:h,"onUpdate:show":O}=e;h&&le(h,i),O&&le(O,i),_.value=i}function de(){X.value||(pe(!0),_.value=!0,e.filterable&&Ae())}function ne(){pe(!1)}function me(){y.value="",D.value=S}const ue=P(!1);function Oe(){e.filterable&&(ue.value=!0)}function fe(){e.filterable&&(ue.value=!1,b.value||me())}function he(){X.value||(b.value?e.filterable?Ae():ne():de())}function Fe(i){var h,O;!((O=(h=T.value)===null||h===void 0?void 0:h.selfRef)===null||O===void 0)&&O.contains(i.relatedTarget)||(c.value=!1,j(i),ne())}function Re(i){ae(i),c.value=!0}function Me(i){c.value=!0}function ye(i){var h;!((h=F.value)===null||h===void 0)&&h.$el.contains(i.relatedTarget)||(c.value=!1,j(i),ne())}function we(){var i;(i=F.value)===null||i===void 0||i.focus(),ne()}function ie(i){var h;b.value&&(!((h=F.value)===null||h===void 0)&&h.$el.contains(Cn(i))||ne())}function u(i){if(!Array.isArray(i))return[];if(Z.value)return Array.from(i);{const{remote:h}=e,{value:O}=M;if(h){const{value:K}=H;return i.filter(z=>O.has(z)||K.has(z))}else return i.filter(K=>O.has(K))}}function C(i){Q(i.rawNode)}function Q(i){if(X.value)return;const{tag:h,remote:O,clearFilterAfterSelect:K,valueField:z}=e;if(h&&!O){const{value:A}=D,I=A[0]||null;if(I){const J=R.value;J.length?J.push(I):R.value=[I],D.value=S}}if(O&&H.value.set(i[z],i),e.multiple){const A=u(p.value),I=A.findIndex(J=>J===i[z]);if(~I){if(A.splice(I,1),h&&!O){const J=ze(i[z]);~J&&(R.value.splice(J,1),K&&(y.value=""))}}else A.push(i[z]),K&&(y.value="");g(A,B(A))}else{if(h&&!O){const A=ze(i[z]);~A?R.value=[R.value[A]]:R.value=S}_e(),ne(),g(i[z],i)}}function ze(i){return R.value.findIndex(O=>O[e.valueField]===i)}function je(i){b.value||de();const{value:h}=i.target;y.value=h;const{tag:O,remote:K}=e;if(Te(h),O&&!K){if(!h){D.value=S;return}const{onCreate:z}=e,A=z?z(h):{[e.labelField]:h,[e.valueField]:h},{valueField:I}=e;m.value.some(J=>J[I]===A[I])||R.value.some(J=>J[I]===A[I])?D.value=S:D.value=[A]}}function He(i){i.stopPropagation();const{multiple:h}=e;!h&&e.filterable&&ne(),ee(),h?g([],[]):g(null,null)}function Ge(i){!De(i,"action")&&!De(i,"empty")&&i.preventDefault()}function Ue(i){ke(i)}function Ie(i){var h,O,K,z,A;switch(i.key){case" ":if(e.filterable)break;i.preventDefault();case"Enter":if(!(!((h=F.value)===null||h===void 0)&&h.isComposing)){if(b.value){const I=(O=T.value)===null||O===void 0?void 0:O.getPendingTmNode();I?C(I):e.filterable||(ne(),_e())}else if(de(),e.tag&&ue.value){const I=D.value[0];if(I){const J=I[e.valueField],{value:Ne}=p;e.multiple&&Array.isArray(Ne)&&Ne.some(Xe=>Xe===J)||Q(I)}}}i.preventDefault();break;case"ArrowUp":if(i.preventDefault(),e.loading)return;b.value&&((K=T.value)===null||K===void 0||K.prev());break;case"ArrowDown":if(i.preventDefault(),e.loading)return;b.value?(z=T.value)===null||z===void 0||z.next():de();break;case"Escape":b.value&&(Tn(i),ne()),(A=F.value)===null||A===void 0||A.focus();break}}function _e(){var i;(i=F.value)===null||i===void 0||i.focus()}function Ae(){var i;(i=F.value)===null||i===void 0||i.focusInput()}function qe(){var i;!b.value||(i=W.value)===null||i===void 0||i.syncPosition()}be(),Se(te(e,"options"),be);const Ye={focus:()=>{var i;(i=F.value)===null||i===void 0||i.focus()},blur:()=>{var i;(i=F.value)===null||i===void 0||i.blur()}},Be=V(()=>{const{self:{menuBoxShadow:i}}=s.value;return{"--n-menu-box-shadow":i}}),ce=l?ut("select",void 0,Be,e):void 0;return Object.assign(Object.assign({},Ye),{mergedStatus:d,mergedClsPrefix:t,mergedBordered:n,namespace:o,treeMate:x,isMounted:wn(),triggerRef:F,menuRef:T,pattern:y,uncontrolledShow:_,mergedShow:b,adjustedTo:at(e),uncontrolledValue:a,mergedValue:p,followerRef:W,localizedPlaceholder:E,selectedOption:q,selectedOptions:U,mergedSize:L,mergedDisabled:X,focused:c,activeWithoutMenuOpen:ue,inlineThemeDisabled:l,onTriggerInputFocus:Oe,onTriggerInputBlur:fe,handleTriggerOrMenuResize:qe,handleMenuFocus:Me,handleMenuBlur:ye,handleMenuTabOut:we,handleTriggerClick:he,handleToggle:C,handleDeleteOption:Q,handlePatternInput:je,handleClear:He,handleTriggerBlur:Fe,handleTriggerFocus:Re,handleKeydown:Ie,handleMenuAfterLeave:me,handleMenuClickOutside:ie,handleMenuScroll:Ue,handleMenuKeydown:Ie,handleMenuMousedown:Ge,mergedTheme:s,cssVars:l?void 0:Be,themeClass:ce==null?void 0:ce.themeClass,onRender:ce==null?void 0:ce.onRender})},render(){return f("div",{class:`${this.mergedClsPrefix}-select`},f(zn,null,{default:()=>[f(In,null,{default:()=>f(yo,{ref:"triggerRef",inlineThemeDisabled:this.inlineThemeDisabled,status:this.mergedStatus,inputProps:this.inputProps,clsPrefix:this.mergedClsPrefix,showArrow:this.showArrow,maxTagCount:this.maxTagCount,bordered:this.mergedBordered,active:this.activeWithoutMenuOpen||this.mergedShow,pattern:this.pattern,placeholder:this.localizedPlaceholder,selectedOption:this.selectedOption,selectedOptions:this.selectedOptions,multiple:this.multiple,renderTag:this.renderTag,renderLabel:this.renderLabel,filterable:this.filterable,clearable:this.clearable,disabled:this.mergedDisabled,size:this.mergedSize,theme:this.mergedTheme.peers.InternalSelection,labelField:this.labelField,valueField:this.valueField,themeOverrides:this.mergedTheme.peerOverrides.InternalSelection,loading:this.loading,focused:this.focused,onClick:this.handleTriggerClick,onDeleteOption:this.handleDeleteOption,onPatternInput:this.handlePatternInput,onClear:this.handleClear,onBlur:this.handleTriggerBlur,onFocus:this.handleTriggerFocus,onKeydown:this.handleKeydown,onPatternBlur:this.onTriggerInputBlur,onPatternFocus:this.onTriggerInputFocus,onResize:this.handleTriggerOrMenuResize,ignoreComposition:this.ignoreComposition},{arrow:()=>{var e,t;return[(t=(e=this.$slots).arrow)===null||t===void 0?void 0:t.call(e)]}})}),f(_n,{ref:"followerRef",show:this.mergedShow,to:this.adjustedTo,teleportDisabled:this.adjustedTo===at.tdkey,containerClass:this.namespace,width:this.consistentMenuWidth?"target":void 0,minWidth:"target",placement:this.placement},{default:()=>f(Rt,{name:"fade-in-scale-up-transition",appear:this.isMounted,onAfterLeave:this.handleMenuAfterLeave},{default:()=>{var e,t,n;return this.mergedShow||this.displayDirective==="show"?((e=this.onRender)===null||e===void 0||e.call(this),xn(f(po,Object.assign({},this.menuProps,{ref:"menuRef",onResize:this.handleTriggerOrMenuResize,inlineThemeDisabled:this.inlineThemeDisabled,virtualScroll:this.consistentMenuWidth&&this.virtualScroll,class:[`${this.mergedClsPrefix}-select-menu`,this.themeClass,(t=this.menuProps)===null||t===void 0?void 0:t.class],clsPrefix:this.mergedClsPrefix,focusable:!0,labelField:this.labelField,valueField:this.valueField,autoPending:!0,nodeProps:this.nodeProps,theme:this.mergedTheme.peers.InternalSelectMenu,themeOverrides:this.mergedTheme.peerOverrides.InternalSelectMenu,treeMate:this.treeMate,multiple:this.multiple,size:"medium",renderOption:this.renderOption,renderLabel:this.renderLabel,value:this.mergedValue,style:[(n=this.menuProps)===null||n===void 0?void 0:n.style,this.cssVars],onToggle:this.handleToggle,onScroll:this.handleMenuScroll,onFocus:this.handleMenuFocus,onBlur:this.handleMenuBlur,onKeydown:this.handleMenuKeydown,onTabOut:this.handleMenuTabOut,onMousedown:this.handleMenuMousedown,show:this.mergedShow,showCheckmark:this.showCheckmark,resetMenuOnOptionsChange:this.resetMenuOnOptionsChange}),{empty:()=>{var o,l;return[(l=(o=this.$slots).empty)===null||l===void 0?void 0:l.call(o)]},action:()=>{var o,l;return[(l=(o=this.$slots).action)===null||l===void 0?void 0:l.call(o)]}}),this.displayDirective==="show"?[[Sn,this.mergedShow],[bt,this.handleMenuClickOutside,void 0,{capture:!0}]]:[[bt,this.handleMenuClickOutside,void 0,{capture:!0}]])):null}})})]}))}});export{po as N,Ln as V,_o as _,wo as a,vo as c,Bn as g,De as h,Je as m};
